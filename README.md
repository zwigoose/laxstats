...
- **All Games** — view and score every game across all users
- **Users** — create and delete accounts, promote or revoke admin status, and see each user's game history
- **Rosters** — view and edit any roster across all users
