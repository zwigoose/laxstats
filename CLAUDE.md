...
- **`game_meta_events`** — legacy quarter-transition table, kept only for pre-Phase-3 clients; a forwarding trigger copies inserts into the stream with deterministic ids (dropped in Phase 5)
