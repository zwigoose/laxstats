-- Revert 00012: restore additive formula where NULL org bonus (giga) = unlimited result.
-- A free user in a giga org gets 3 + ∞ = ∞ personal games (NULL returned).
-- The UI now renders the banner even when game_limit is null, showing "X / ∞".
