...
export default function TimeKeypad({ maxSeconds, ceilingSecs, allowEqualToCeiling = false, onConfirm, showSameAsLatest = false, latestLabel = null, oneHandedMode = false }) {
  ...
  const keyStyle = (special) => ({
    padding: oneHandedMode ? "20px 0" : "16px 0",
    fontSize: special ? (oneHandedMode ? 20 : 18) : (oneHandedMode ? 24 : 22),
  ...
  const displaySection = (
    <div>
      <div style={{ textAlign: "center", marginBottom: 4 }}>
        <span style={{ fontSize: oneHandedMode ? 36 : 48, fontWeight: 300, letterSpacing: "0.04em", fontVariantNumeric: "tabular-nums", color: canUse ? "#111" : errorMsg ? "#c0392b" : digits.length > 0 ? "#111" : "#ccc" }}>
