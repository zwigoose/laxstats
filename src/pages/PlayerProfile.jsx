...
const S = {
  ...
  statBox: { background: "#fff", padding: "24px 12px", textAlign: "center", minWidth: 0 },
  statVal: { fontSize: 22, fontWeight: 700, color: "#111", display: "block", lineHeight: 1.1 },
  statLbl: { fontSize: 10, fontWeight: 700, color: "#888", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: 6, display: "block" },
