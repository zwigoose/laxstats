const S = {
  ...
  oneHandedContainer: (active) => ({
    ...
    left: active ? 0 : "auto",
    right: active ? 0 : "auto",
    height: active ? "100dvh" : "auto",
    padding: active ? "12px 12px 0 12px" : "0",
    paddingBottom: active ? "max(12px, env(safe-area-inset-bottom))" : "0",
    background: active ? "rgba(255,255,255,0.95)" : "transparent",
    backdropFilter: active ? "blur(10px)" : "none",
    zIndex: active ? 100 : 1,
    overflowY: active ? "auto" : "visible",
  }),
  oneHandedControls: (active) => ({
    display: active ? "grid" : "contents",
    gridTemplateColumns: active ? "repeat(3, 1fr)" : "initial",
    gap: active ? "8px" : "0",
    paddingBottom: active ? "max(20px, env(safe-area-inset-bottom))" : "0",
  }),
  teamBtnsOneHanded: {
    display: "grid",
  ...
  playerBtnOneHanded: (sel, color, isHome) => ({
    ...
    border: isHome
      ? (sel ? "3px solid #fff" : `4px solid ${color || "#555"}`)
      : (sel ? "3px solid #fff" : "2px solid transparent"),
    outline: sel ? "3px solid " + (color || "#555") : "none",
    boxSizing: "border-box",
    boxShadow: "0 2px 6px rgba(0,0,0,0.05)",
  }),
  playerNumOneHanded: (sel, isHome, color) => ({
    fontSize: "24px",
    fontWeight: 700,
    display: "block",
    color: (isHome && !sel) ? (color || "#555") : "#fff"
  }),
  playerNameOneHanded: (sel, isHome, color) => ({
    fontSize: "11px",
    color: (isHome && !sel) ? "#888" : "rgba(255,255,255,0.85)",
    marginTop: 4,
